...
app.get('/home/pick_color', function(req, res) {
	...
	// console.log('Color Choice: ', color_choice);
	var color_options =  'select * from favorite_colors;';
	// console.log('Color Options: ', color_options);
	var color_message = "select color_msg from favorite_colors where hex_value = '" + color_choice + "';";
	// console.log('Color Messgae: ', color_message);
	db.task('get-everything', task => {
        return task.batch([
...
app.get('/home/player_info/select_player', function(req, res) {
	...
	var query3 = 'SELECT count(*) FROM football_games JOIN football_players ON football_players.id = ANY(football_games.players) WHERE football_players.id = ' + id + ';'
